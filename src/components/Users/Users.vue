<template>
  <div class="parentContainer">
    <div class="container">
      ...
      <v-data-table :headers="headers" :items="filteredUsers" :search="search" class="table" style=" text-align: center; ">
        <!-- Add new user part -->
        <template v-slot:top>
            ...
            <v-dialog v-model="dialog" max-width="500px">
              ...
              <template v-slot:activator="{ props }">
                <div class="addActions">
                  <div >
                    <v-btn style="background-color: #009688;" icon color="white" @click="resetWH" v-bind:class="{ 'importUsersButton': true }">
                      <v-icon size="small">
                        mdi-history
                      </v-icon>
